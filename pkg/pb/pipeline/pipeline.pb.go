...
func (SessionLoggerInfo_LogLevel) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_7ac67a7adf3df9c7, []int{54, 0}
}
...
func (Pipeline_PipelineType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_7ac67a7adf3df9c7, []int{55, 0}
}
...
type PostDml struct {
	...
	IsDeleteWithoutFilters bool                     `protobuf:"varint,7,opt,name=is_delete_without_filters,json=isDeleteWithoutFilters,proto3" json:"is_delete_without_filters,omitempty"`
...
func (m *PostDml) Reset()         { *m = PostDml{} }
func (m *PostDml) String() string { return proto.CompactTextString(m) }
...
func (m *PostDml) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_PostDml.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *PostDml) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PostDml.Merge(m, src)
}
func (m *PostDml) XXX_Size() int {
	return m.ProtoSize()
}
func (m *PostDml) XXX_DiscardUnknown() {
	xxx_messageInfo_PostDml.DiscardUnknown(m)
}

var xxx_messageInfo_PostDml proto.InternalMessageInfo
...
func (m *PostDml) GetIsDeleteWithoutFilters() bool {
	if m != nil {
		return m.IsDeleteWithoutFilters
	}
	return false
}
...
type Instruction struct {
	...
	PostDml                 *PostDml                 `protobuf:"bytes,52,opt,name=post_dml,json=postDml,proto3" json:"post_dml,omitempty"`
	XXX_NoUnkeyedLiteral    struct{}                 `json:"-"`
	XXX_unrecognized        []byte                   `json:"-"`
	XXX_sizecache           int32                    `json:"-"`
}
...
type ShuffleBlockInfo struct {
	CnCnt                int32     `protobuf:"varint,1,opt,name=cn_cnt,json=cnCnt,proto3" json:"cn_cnt,omitempty"`
	CnIdx                int32     `protobuf:"varint,2,opt,name=cn_idx,json=cnIdx,proto3" json:"cn_idx,omitempty"`
	ShuffleType          int32     `protobuf:"varint,3,opt,name=shuffle_type,json=shuffleType,proto3" json:"shuffle_type,omitempty"`
	ShuffleCol           int32     `protobuf:"varint,4,opt,name=shuffle_col,json=shuffleCol,proto3" json:"shuffle_col,omitempty"`
	ColMin               int64     `protobuf:"varint,5,opt,name=col_min,json=colMin,proto3" json:"col_min,omitempty"`
	ColMax               int64     `protobuf:"varint,6,opt,name=col_max,json=colMax,proto3" json:"col_max,omitempty"`
	TableCnt             int64     `protobuf:"varint,7,opt,name=table_cnt,json=tableCnt,proto3" json:"table_cnt,omitempty"`
	NullCnt              int64     `protobuf:"varint,8,opt,name=null_cnt,json=nullCnt,proto3" json:"null_cnt,omitempty"`
	Ranges               []float64 `protobuf:"fixed64,9,rep,packed,name=ranges,proto3" json:"ranges,omitempty"`
	XXX_NoUnkeyedLiteral struct{}  `json:"-"`
	XXX_unrecognized     []byte    `json:"-"`
	XXX_sizecache        int32     `json:"-"`
}

func (m *ShuffleBlockInfo) Reset()         { *m = ShuffleBlockInfo{} }
func (m *ShuffleBlockInfo) String() string { return proto.CompactTextString(m) }
func (*ShuffleBlockInfo) ProtoMessage()    {}
func (*ShuffleBlockInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_7ac67a7adf3df9c7, []int{48}
}
func (m *ShuffleBlockInfo) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ShuffleBlockInfo) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ShuffleBlockInfo.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ShuffleBlockInfo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ShuffleBlockInfo.Merge(m, src)
}
func (m *ShuffleBlockInfo) XXX_Size() int {
	return m.ProtoSize()
}
func (m *ShuffleBlockInfo) XXX_DiscardUnknown() {
	xxx_messageInfo_ShuffleBlockInfo.DiscardUnknown(m)
}

var xxx_messageInfo_ShuffleBlockInfo proto.InternalMessageInfo

func (m *ShuffleBlockInfo) GetCnCnt() int32 {
	if m != nil {
		return m.CnCnt
	}
	return 0
...
func (m *ShuffleBlockInfo) GetCnIdx() int32 {
	if m != nil {
		return m.CnIdx
	}
	return 0
...
func (m *ShuffleBlockInfo) GetShuffleType() int32 {
	if m != nil {
		return m.ShuffleType
	}
	return 0
...
func (m *ShuffleBlockInfo) GetShuffleCol() int32 {
	if m != nil {
		return m.ShuffleCol
	}
	return 0
...
func (m *ShuffleBlockInfo) GetColMin() int64 {
	if m != nil {
		return m.ColMin
	}
	return 0
...
func (m *ShuffleBlockInfo) GetColMax() int64 {
	if m != nil {
		return m.ColMax
	}
	return 0
...
func (m *ShuffleBlockInfo) GetTableCnt() int64 {
	if m != nil {
		return m.TableCnt
	}
	return 0
...
func (m *ShuffleBlockInfo) GetNullCnt() int64 {
	if m != nil {
		return m.NullCnt
	}
	return 0
...
func (m *ShuffleBlockInfo) GetRanges() []float64 {
	if m != nil {
		return m.Ranges
	}
	return nil
...
type NodeInfo struct {
	...
	ShuffleBlockInfo     *ShuffleBlockInfo `protobuf:"bytes,4,opt,name=shuffle_block_info,json=shuffleBlockInfo,proto3" json:"shuffle_block_info,omitempty"`
...
func (m *NodeInfo) GetShuffleBlockInfo() *ShuffleBlockInfo {
	if m != nil {
		return m.ShuffleBlockInfo
	}
	return nil
}
...
func init() {
	...
	proto.RegisterType((*PostDml)(nil), "pipeline.PostDml")
	...
	proto.RegisterType((*ShuffleBlockInfo)(nil), "pipeline.ShuffleBlockInfo")
...
var fileDescriptor_7ac67a7adf3df9c7 = []byte{
	...
	,
}
...
func (m *Group) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.GroupingFlag) > 0 {
		for iNdEx := len(m.GroupingFlag) - 1; iNdEx >= 0; iNdEx-- {
			i--
			if m.GroupingFlag[iNdEx] {
				dAtA[i] = 1
			} else {
				dAtA[i] = 0
			}
		}
		i = encodeVarintPipeline(dAtA, i, uint64(len(m.GroupingFlag)))
		i--
		dAtA[i] = 0x52
	}
...
func (m *PostDml) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.FullText != nil {
		{
			size, err := m.FullText.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if len(m.PrimaryKeyName) > 0 {
		...
		i = encodeVarintPipeline(dAtA, i, uint64(len(m.PrimaryKeyName)))
		i--
		dAtA[i] = 0x22
	}
	if m.PrimaryKeyIdx != 0 {
...
func (m *OnDuplicateKey) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.OnDuplicateIdx) > 0 {
		dAtA33 := make([]byte, len(m.OnDuplicateIdx)*10)
		var j32 int
...
func (m *AntiJoin) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Result) > 0 {
		dAtA42 := make([]byte, len(m.Result)*10)
		var j41 int
...
func (m *RightJoin) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ColList) > 0 {
		dAtA50 := make([]byte, len(m.ColList)*10)
		var j49 int
		for _, num1 := range m.ColList {
			num := uint64(num1)
			for num >= 1<<7 {
	...
	if len(m.RelList) > 0 {
		dAtA52 := make([]byte, len(m.RelList)*10)
		var j51 int
		for _, num1 := range m.RelList {
			num := uint64(num1)
			for num >= 1<<7 {
...
func (m *RightSemiJoin) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Result) > 0 {
		dAtA55 := make([]byte, len(m.Result)*10)
		var j54 int
		for _, num1 := range m.Result {
			num := uint64(num1)
			for num >= 1<<7 {
...
func (m *MarkJoin) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Result) > 0 {
		dAtA69 := make([]byte, len(m.Result)*10)
		var j68 int
		for _, num1 := range m.Result {
			num := uint64(num1)
			for num >= 1<<7 {
...
func (m *FileOffset) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Offset) > 0 {
		dAtA82 := make([]byte, len(m.Offset)*10)
		var j81 int
...
func (m *ExternalScan) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.FileSize) > 0 {
		dAtA85 := make([]byte, len(m.FileSize)*10)
		var j84 int
...
func (m *Instruction) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.PostDml != nil {
		{
			size, err := m.PostDml.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *ShuffleBlockInfo) Marshal() (dAtA []byte, err error) {
	size := m.ProtoSize()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ShuffleBlockInfo) MarshalTo(dAtA []byte) (int, error) {
	size := m.ProtoSize()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ShuffleBlockInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.Ranges) > 0 {
		for iNdEx := len(m.Ranges) - 1; iNdEx >= 0; iNdEx-- {
			f133 := math.Float64bits(float64(m.Ranges[iNdEx]))
			i -= 8
			encoding_binary.LittleEndian.PutUint64(dAtA[i:], uint64(f133))
		}
		i = encodeVarintPipeline(dAtA, i, uint64(len(m.Ranges)*8))
		i--
		dAtA[i] = 0x4a
	}
	if m.NullCnt != 0 {
		i = encodeVarintPipeline(dAtA, i, uint64(m.NullCnt))
		i--
		dAtA[i] = 0x40
	}
	if m.TableCnt != 0 {
		i = encodeVarintPipeline(dAtA, i, uint64(m.TableCnt))
		i--
		dAtA[i] = 0x38
	}
	if m.ColMax != 0 {
		i = encodeVarintPipeline(dAtA, i, uint64(m.ColMax))
		i--
		dAtA[i] = 0x30
	}
	if m.ColMin != 0 {
		i = encodeVarintPipeline(dAtA, i, uint64(m.ColMin))
		i--
		dAtA[i] = 0x28
	}
	if m.ShuffleCol != 0 {
		i = encodeVarintPipeline(dAtA, i, uint64(m.ShuffleCol))
		i--
		dAtA[i] = 0x20
	}
	if m.ShuffleType != 0 {
	...
	if m.CnIdx != 0 {
		i = encodeVarintPipeline(dAtA, i, uint64(m.CnIdx))
		i--
		dAtA[i] = 0x10
	}
	if m.CnCnt != 0 {
		i = encodeVarintPipeline(dAtA, i, uint64(m.CnCnt))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *NodeInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ShuffleBlockInfo != nil {
		{
			size, err := m.ShuffleBlockInfo.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *Pipeline) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.NilBatchCnt) > 0 {
		dAtA141 := make([]byte, len(m.NilBatchCnt)*10)
		var j140 int
		...
		i = encodeVarintPipeline(dAtA, i, uint64(j140))
		i--
		dAtA[i] = 0x6a
	}
	if len(m.ChannelBufferSize) > 0 {
		dAtA143 := make([]byte, len(m.ChannelBufferSize)*10)
		var j142 int
...
func (m *Apply) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ColList) > 0 {
		dAtA148 := make([]byte, len(m.ColList)*10)
		var j147 int
		for _, num1 := range m.ColList {
			num := uint64(num1)
			for num >= 1<<7 {
	...
	if len(m.RelList) > 0 {
		dAtA150 := make([]byte, len(m.RelList)*10)
		var j149 int
		for _, num1 := range m.RelList {
			num := uint64(num1)
			for num >= 1<<7 {
		...
		i = encodeVarintPipeline(dAtA, i, uint64(j149))
		i--
		dAtA[i] = 0x12
	}
	if m.ApplyType != 0 {
...
func (m *Group) ProtoSize() (n int) {
	...
	if len(m.GroupingFlag) > 0 {
		n += 1 + sovPipeline(uint64(len(m.GroupingFlag))) + len(m.GroupingFlag)*1
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *ShuffleBlockInfo) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.CnCnt != 0 {
		n += 1 + sovPipeline(uint64(m.CnCnt))
	}
	if m.CnIdx != 0 {
		n += 1 + sovPipeline(uint64(m.CnIdx))
	}
	if m.ShuffleType != 0 {
		n += 1 + sovPipeline(uint64(m.ShuffleType))
	}
	if m.ShuffleCol != 0 {
		n += 1 + sovPipeline(uint64(m.ShuffleCol))
	}
	if m.ColMin != 0 {
		n += 1 + sovPipeline(uint64(m.ColMin))
	}
	if m.ColMax != 0 {
		n += 1 + sovPipeline(uint64(m.ColMax))
	}
	if m.TableCnt != 0 {
		n += 1 + sovPipeline(uint64(m.TableCnt))
	}
	if m.NullCnt != 0 {
		n += 1 + sovPipeline(uint64(m.NullCnt))
	}
	if len(m.Ranges) > 0 {
		n += 1 + sovPipeline(uint64(len(m.Ranges)*8)) + len(m.Ranges)*8
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *NodeInfo) ProtoSize() (n int) {
	...
	if m.ShuffleBlockInfo != nil {
		l = m.ShuffleBlockInfo.ProtoSize()
		n += 1 + l + sovPipeline(uint64(l))
	}
	l = len(m.Payload)
	if l > 0 {
	...
	for iNdEx < l {
		...
		case 10:
			if wireType == 0 {
				...
				m.GroupingFlag = append(m.GroupingFlag, bool(v != 0))
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				if elementCount != 0 && len(m.GroupingFlag) == 0 {
					m.GroupingFlag = make([]bool, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v int
					for shift := uint(0); ; shift += 7 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field GroupingFlag", wireType)
			}
		default:
			iNdEx = preIndex
			skippy, err := skipPipeline(dAtA[iNdEx:])
...
func (m *PostDml) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PostDml: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PostDml: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field IsInsert", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field IsDeleteWithoutFilters", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.IsDeleteWithoutFilters = bool(v != 0)
		case 8:
			if wireType != 2 {
			...
			if m.FullText == nil {
				m.FullText = &plan.PostDmlFullTextCtx{}
			}
			if err := m.FullText.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *Instruction) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 52:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PostDml", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.PostDml.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *ShuffleBlockInfo) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ShuffleBlockInfo: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ShuffleBlockInfo: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field CnCnt", wireType)
			}
			m.CnCnt = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field CnIdx", wireType)
			}
			m.CnIdx = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ShuffleCol", wireType)
			}
			m.ShuffleCol = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ShuffleCol |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ColMin", wireType)
			}
			m.ColMin = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ColMax", wireType)
			}
			m.ColMax = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *NodeInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ShuffleBlockInfo", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ShuffleBlockInfo == nil {
				m.ShuffleBlockInfo = &ShuffleBlockInfo{}
			}
			if err := m.ShuffleBlockInfo.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 5:
